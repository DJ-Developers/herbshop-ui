...
export default function SinglePostPage() {
  return (
    <div>
      ...
      <div className='w-full lg:h-[480px] h-96 relative overflow-hidden before:absolute before:content-["] before:w-full before:h-full before:top-0 before:left-0 before:bg-gray-900/70'>
        <Image
        ...
        <div className=' absolute top-0 w-full h-full'>
          <div className=' max-w-6xl m-auto flex flex-col justify-between h-full px-6'>
      ...
      {/* CONTENS */}
      <div className='max-w-3xl m-auto lg:p-6 p-4'>
